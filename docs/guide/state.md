...
The data you store in Vuex follows the same rules as the `data` in a Vue instance, if the state object must be plain. **See also:** [Vue#data](https://vuejs.org/v2/api/#data).
