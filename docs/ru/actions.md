Замечание касательно верстки всех страниц для моб. приложения. Необходимо установить для тега section c классами ".normal.markdown-section" параметр cо значением "width: 100%". Иначе контент схлопывается или имеет справа отступ
# Действия
