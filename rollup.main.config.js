...
export default createEntries([
  { input: 'src/index.js', file: 'dist/vuex.esm.js', format: 'es', browser: true, env: 'development' },
  { input: 'src/index.js', file: 'dist/vuex.esm.prod.js', format: 'es', browser: true, env: 'production' },
